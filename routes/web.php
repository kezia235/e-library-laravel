...
Route::middleware(['auth'])->group(function () {
    ...
    //edit user
    Route::get('/arsip/editprofil', [AdminController::class, 'editprofil'])->name('editprofil');
    Route::post('/arsip/editprofile/save/{id}', [AdminController::class, 'saveprofil'])->name('saveprofil');
